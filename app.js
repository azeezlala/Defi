...
//to connect my node(writing to bc) from this node
const web3 = new Web3('https://rinkeby.infura.io/v3/7e98509af1574b3ab95128b0f9ba6bf8')
const account = "0xc8C582e24e4b9d729889067457cC342fEbb58c55" //ethereum address
web3.eth.accounts.wallet.add("9afa66f93e64a268adbb5aedfcef72e2bfbd76116c824f79afb8b96c61ab721d") //private key to sign transaction
...
// contract to metamask
/*const contractAddress = '' //this will contain my SC address
const provider = new ethers.providers.Web3Provider(window.ethereum);
const signer = provider.getSigner() //this is going to get the connected account
const contract = new ethers.Contract(contractAddress, abi, signer);
await contract.function() //you can call a function
*/
run = async () => {
    let result
    ...
    result = await dai.methods.transfer(to, '100').send({
        from: account,
        gasLimit: 6000000,
